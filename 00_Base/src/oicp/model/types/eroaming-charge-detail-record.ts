...
import { ERoamingChargeDetailRecordCalibrationLawVerificationInfo } from './eroaming-charge-detail-record-calibration-law-verification-info';
import { ERoamingChargeDetailRecordMeterValueInBetween } from './eroaming-charge-detail-record-meter-value-in-between';
import { ERoamingChargeDetailRecordSignedMeteringValues } from './eroaming-charge-detail-record-signed-metering-values';
...
export interface ERoamingChargeDetailRecord {
     ...
     *
     * @type {Array<ERoamingChargeDetailRecordSignedMeteringValues>}
     * @memberof ERoamingChargeDetailRecord
     */
    signedMeteringValues?: Array<ERoamingChargeDetailRecordSignedMeteringValues>;

    /**
     * @type {ERoamingChargeDetailRecordCalibrationLawVerificationInfo}
     * @memberof ERoamingChargeDetailRecord
     */
    calibrationLawVerificationInfo?: ERoamingChargeDetailRecordCalibrationLawVerificationInfo;
